...
class Plotter:
    ...
    def _get_traf_peaks(self, sessions: list[Session]) -> tuple[list[int], list[float], int]:
    ...
    def _get_time_peaks(self, sessions: list[Session]) -> tuple[list[int], list[float], int]:
